...
- [ ] **#2** — Build Layout shell *(blocked by #1)*
...
- [ ] **#5** — Build content primitive components *(blocked by #4)*
...
- [ ] **#6** — Build compound components *(blocked by #5)*
...
- [ ] **#7** — Create Community Board JSON data files *(blocked by #6)*
...
- [ ] **#8** — Build CommunityBoard page *(blocked by #7)*
...
- [ ] **#12** — Set up GitHub Actions deploy *(blocked by #8, #9, #10, #11)*
...
- [ ] **#13** — Full validation pass *(blocked by #12)*
